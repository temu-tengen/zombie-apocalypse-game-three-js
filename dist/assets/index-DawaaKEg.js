...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ka(e,t,n){return new Yr({name:`SphericalGaussianBlur`,defines:{SAMPLES:ma,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ma(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Aa(){return new Yr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ma(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ja(){return new Yr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ma(),fragmentShader:`
